...
import { GetQuoteHeroSection } from "./sections/GetQuoteHeroSection/GetQuoteHeroSection";
import { GetQuoteFormSection } from "./sections/GetQuoteFormSection/GetQuoteFormSection";
import { GetQuoteCTASection } from "./sections/GetQuoteCTASection/GetQuoteCTASection";

export const GetQuotePage = (): JSX.Element => {
  return (
