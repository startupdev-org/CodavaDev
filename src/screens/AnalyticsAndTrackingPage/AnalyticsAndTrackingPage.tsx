...
import { AnalyticsAndTrackingCTASection } from "./sections/AnalyticsAndTrackingCTASection/AnalyticsAndTrackingCTASection";
import { AnalyticsAndTrackingFAQSection } from "./sections/AnalyticsAndTrackingFAQSection/AnalyticsAndTrackingFAQSection";

export const AnalyticsAndTrackingPage = () => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#00041F] via-[#00020F] to-[#00041F] relative overflow-hidden">
      ...
      <main className="relative z-10">
        ...
        <AnalyticsAndTrackingFeaturesSection />
        <AnalyticsAndTrackingFAQSection />
        <AnalyticsAndTrackingCTASection />
      </main>
      <FooterSection />
    </div>
  );
