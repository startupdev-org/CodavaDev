...
import { DigitalAdvertisingCTASection } from "./sections/DigitalAdvertisingCTASection";

export const DigitalAdvertisingPage = (): JSX.Element => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#00041F] via-[#00020F] to-[#00041F] relative overflow-hidden">
      ...
      <main className="relative z-10">
        <DigitalAdvertisingHeroSection />
        <DigitalAdvertisingFeaturesSection />
        <DigitalAdvertisingCTASection />
      </main>
