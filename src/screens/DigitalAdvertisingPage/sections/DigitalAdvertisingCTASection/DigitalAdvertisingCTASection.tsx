...
export const DigitalAdvertisingCTASection = () => {
  ...
  const benefits = t('digital_advertising.cta.benefits', { returnObjects: true }) as Array<{
    title: string;
    description: string;
  }>;
  return (
      ...
      <div className="relative max-w-4xl mx-auto px-6 text-center">
        ...
        <FadeIn delay={0.1} direction="up">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#194EFF]/10 border border-[#194EFF]/20 rounded-full backdrop-blur-sm mb-8">
            ...
            <span className="text-[#194EFF] text-sm font-medium">{t('digital_advertising.cta.badge')}</span>
          </div>
        </FadeIn>

        <FadeIn delay={0.2} direction="up">
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
            {t('digital_advertising.cta.title')}
            <span className="block bg-gradient-to-r from-[#194EFF] to-[#4169E1] bg-clip-text text-transparent leading-[1.2] pb-2 -mb-2">
              {t('digital_advertising.cta.title_highlight')}
            </span>
          </h2>
        </FadeIn>
        ...
        <FadeIn delay={0.3} direction="up">
          <p className="text-xl text-white/70 leading-relaxed mb-12 max-w-2xl mx-auto">
            {t('digital_advertising.cta.description')}
          </p>
        </FadeIn>
        ...
        <FadeIn delay={0.4} direction="up">
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-12">
            <GlowButton className="group px-10 py-4 bg-[#194EFF] hover:bg-[#194EFF]/90 rounded-xl font-semibold text-lg transition-all duration-300 flex items-center gap-3 shadow-2xl hover:shadow-[#194EFF]/30 hover:scale-105 transform relative overflow-hidden text-white">
              ...
              <span className="relative z-10">{t('digital_advertising.cta.button_primary')}</span>
            ...
            <GlowButton className="group px-10 py-4 bg-white/[0.03] border border-[#194EFF]/30 hover:border-[#194EFF]/50 hover:bg-white/[0.05] rounded-xl font-semibold text-white text-lg transition-all duration-300 backdrop-blur-sm hover:scale-105 transform shadow-lg relative overflow-hidden">
              ...
              <span className="relative z-10 flex items-center gap-3">
                {t('digital_advertising.cta.button_secondary')}
        ...
        <FadeIn delay={0.5} direction="up">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className="flex flex-col items-center">
              ...
              <h3 className="text-lg font-semibold text-white mb-2">{benefits[0].title}</h3>
              <p className="text-white/60 text-sm">{benefits[0].description}</p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <h3 className="text-lg font-semibold text-white mb-2">{benefits[1].title}</h3>
              <p className="text-white/60 text-sm">{benefits[1].description}</p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <h3 className="text-lg font-semibold text-white mb-2">{benefits[2].title}</h3>
              <p className="text-white/60 text-sm">{benefits[2].description}</p>
            </div>
          </div>
        </FadeIn>
