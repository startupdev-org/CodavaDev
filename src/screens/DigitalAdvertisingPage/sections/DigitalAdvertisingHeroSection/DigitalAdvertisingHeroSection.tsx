      ...
      <div className="relative max-w-6xl mx-auto px-6 text-center pt-12 pb-16">
        ...
        <FadeIn delay={0.1} direction="up">
          <div className="inline-flex items-center gap-2 px-5 py-2.5 bg-white/5 border border-white/10 rounded-full backdrop-blur-sm mb-12">
            ...
            <span className="text-white/80 text-sm font-medium">📢 Digital Advertising • Google Ads • Facebook Ads • Performance Marketing</span>
          </div>
        </FadeIn>
        ...
        <FadeIn delay={0.3} direction="up">
          <p className="text-xl text-white/70 leading-relaxed max-w-3xl mx-auto mb-12">
            Reach your ideal customers with precision-targeted advertising campaigns across Google, Facebook, Instagram, and LinkedIn. We optimize for maximum ROI and conversions.
          </p>
        </FadeIn>
