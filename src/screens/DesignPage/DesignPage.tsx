...
export const DesignPage = () => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#00041F] via-[#00020F] to-[#00041F] relative overflow-hidden">
      ...
      <Seo title="UI/UX Design Services" description="CodavaDev designs clean, conversion-focused interfaces and brand systems - from wireframes to polished, developer-ready UI." path="/services/design" />
      <HeaderSection />
